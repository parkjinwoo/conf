#!/usr/bin/env bash
# Base16 Parkjinwoo - Gnome Terminal color scheme install script
...
gset string palette "#0d0d0d:#ba1820:#6fac24:#ffac30:#188cb5:#ac40a8:#40e894:#d0d0d0:#606060:#ba1820:#6fac24:#ffac30:#188cb5:#ac40a8:#40e894:#f8f8f8"
gset string background_color "#0d0d0d"
